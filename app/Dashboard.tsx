...
export default function Dashboard() {
  ...
  return <main className="storefront" ref={storefrontRef}>
    <header className="public-nav">
      ...
      <nav className={menuOpen ? "open" : ""}><a href="#capabilities">解决方案</a><a href="#showcase">效果展示</a><a href="#video-gallery">视频灵感</a><a href="#studio">制作中心</a><a href="/history">历史记录</a><a href="/pricing">订阅价格</a><a href="/admin">运营后台</a></nav>
